...
template <class E>
class tensor_core<subtensor_engine<E>>
  : public detail::tensor_expression<tensor_core<subtensor_engine<E>>,
                                     tensor_core<subtensor_engine<E>>> {
public:
    ...
    tensor_core(const tensor_core<eng>& tens) {}

};

template <typename E>
using subtensor = tensor_core<subtensor_engine<E>>;

template <typename E> auto make_subtensor(const tensor_core<E>& tens)
{
  return subtensor<E>(tens);
}
